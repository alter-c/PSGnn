(define (problem subway)
    ...
    (:objects 
		...
		3_Hao_HangZhanLou - station
		2_Hao_HangZhanLou - station
    ...
    (:init
		...
		(connected 3_Hao_HangZhanLou 2_Hao_HangZhanLou Capital_Airport_Express)
		(connected 2_Hao_HangZhanLou SanYuan_Qiao Capital_Airport_Express)
